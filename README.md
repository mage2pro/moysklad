The extension integrates your Magento 2 store with the **[МойСклад](https://www.moysklad.ru)** ERP / CRM software.  
...
### 2. Self-installation
```
composer require mage2pro/moysklad:*
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/moysklad).
